...
public class Purchaser : MonoBehaviour, IStoreListener
{
    ...
    public const string kProductID_NoAds = "com.musicchallenge.fmfmod.modcharacter.remove.ads";
    ...
    {
        EventManager.AddListener(GameEvent.REMOVE_ADS, BuyNoAds);
    }

    private void OnDisable()
    {
        EventManager.RemoveListener(GameEvent.REMOVE_ADS, BuyNoAds);
    }
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, kProductID_NoAds, StringComparison.Ordinal))
        {
            ...
            UIManager.Instance.btn_RemoveAds.gameObject.SetActive(false);
